...
ggplot(BR_complete, aes(x = Date, y = Rainfall))+
  ...
  labs(title = "Rainfall in Brazil Over Time")

ggplot(BR_complete, aes(x = Date, y = Temperature_C))+
  geom_line()+
  geom_smooth(method=lm)+
  labs(title = "Temperature (C) in Brazil Over Time")+
...
BR_temperature_components <- mutate(BR_temperature_components,
...
ggplot(BR_rainfall_components) +
  ...
  geom_line(aes(y = remainder, x = Date), color = "green")+
  geom_hline(yintercept = 0, lty = 2) 

 
ggplot(BR_temperature_components) +
  geom_line(aes(y = Observed, x = Date),  size = 0.25) +
  geom_line(aes(y = trend, x = Date), color = "#c13d75ff") +
  geom_line(aes(y = seasonal, x = Date), color = "blue")+
  geom_line(aes(y = remainder, x = Date), color = "green")+
