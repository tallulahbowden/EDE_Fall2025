...
df_energy <- data.frame("Name" = as.factor(the_states),
                        "Average Retail Price" = as.numeric(the_price),
                        "Net Summer Capacity" = as.numeric(gsub(',','',the_capacity)),
                        "Net Generation" = as.numeric(gsub(',','',net_generation)),
                        "Total Retail Sales" = as.numeric(gsub(',','',total_retail)))
