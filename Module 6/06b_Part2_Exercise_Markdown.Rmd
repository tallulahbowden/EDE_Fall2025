...
```{r create tables, echo = F}
knitr::kable(nutrient_data_tn, 
             caption = "Summary of Total Nitrogen",
             col.names = c("Lake Name", "Mean Total Nitrogen", "Min Total Nitrogen", "Max Total Nitrogen", "Standard Deviation Total Nitrogen"))

knitr::kable(nutrient_data_tn,
             caption = "Another Summary")
```
